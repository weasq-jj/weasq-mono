...
export const Login = ({ provider = 'keycloak', bodyClassName = 'bg-slate-900', className }: LoginProps) => {
  ...
  return (
    <div className={clsx('flex', 'min-h-screen', 'items-center', 'justify-center', 'animate-pulse', className)}>
      <svg className={clsx('h-24', 'w-24')} viewBox="164.025 141.712 33.733 40.653" xmlns="http://www.w3.org/2000/svg">
        <path
